...
struct OnboardingView: View {
    //MARK: - PROPERTY
    //only sets the defaults variable if it isnt initialized yet. If it is, the end of the line is ignored
    @AppStorage("onboarding") var isOnboardingViewActive: Bool = true
    
    @State private var sliderWidth: Double = UIScreen.main.bounds.width - 80
                    ...
                    HStack {
                        ...
                        .gesture(
                            DragGesture()
                                ...
                                .onEnded { _ in
                                    if buttonOffset > (sliderWidth / 1.5) {
